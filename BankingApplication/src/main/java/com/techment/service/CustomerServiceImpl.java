...
public class CustomerServiceImpl implements ICustomerService {
	...
	@Override
	public CustomerDto  LoginUser(long customer_id,String customer_name) {
		Customer customer = Dao.findByCustomerIdAndCustomerName(customer_id,customer_name);
		CustomerDto  customerDto = new CustomerDto (customer.getCustomerId(),customer.getCustomerName(),customer.getPhoneNo(),customer.getEmailID(),customer.getAge(),customer.getGender());
		return  customerDto;
	}
